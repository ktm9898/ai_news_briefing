...
- **중요**: 사소한 매장 오픈, 지엽적인 지역 상권 소식, 개인적인 미담 등은 제외하세요.
- **선정 기준**: 국가 단위의 거시 경제 지표(금리, 환율), 글로벌 대기업의 명운을 가르는 결정적 뉴스, 업계의 판도를 바꾸는 혁신적 기술 발표 등 **'헤드라인급 묵직한 뉴스'**를 우선하세요.
- 국내외를 가리지 말고 전 세계 경영·경제의 흐름을 가장 잘 보여주는 뉴스 5개를 엄선하세요.
