...
3. 각 인사이트 항목은 'title'(뉴스 제목, 원문 그대로 생략 없이 전체 작성), 'summary'(주요내용), 'implication'(시사점)으로 구성하십시오.
   ...
   - **[외부 사례 출처 표기]**: 시사점(implication)에서 당신이 새롭게 제시한 **외부 유사 사례나 레퍼런스(예: 미국 푸드스탬프 사례, 영국 챌린저뱅크 등)**에 대한 출처를 표기하십시오. **주의: 현재 요약하고 있는 원본 기사의 출처를 동어반복하여 적지 마십시오.** 외부 사례를 언급한 경우, 내용이 모두 끝난 후 **새로운 줄(빈 줄)을 하나 추가하고** `[참고 출처: 사례와 관련된 실제 언론사명 "관련 기사 제목 또는 보고서명"]` 형태로 명확한 출처명과 제목을 표기해 주십시오.
...
3. 각 인사이트 항목은 'title'(뉴스 제목, 원문 그대로 생략 없이 전체 작성), 'summary'(주요내용 요약), 'implication'(사업운영 인사이트)으로 구성하십시오.
   - **summary 작성 가이드**: 단순 요약을 넘어 기사의 배경, 구체적인 수치, 핵심 쟁점 등을 기존보다 1~2줄 더 상세하고 구체적으로 설명하십시오.
   - **implication(사업운영 인사이트) 작성 가이드**: 단순히 기사를 해설하는 것을 넘어, 소상공인 사장님이 실질적으로 어떻게 대비하거나 활용해야 하는지 구체적인 비즈니스 팁, 대응 방안, 아이디어를 제공해야 합니다. 가급적 국내외 유사 성공/실패 사례나 레퍼런스를 인용하여 구체성을 높이십시오.
   - **[외부 사례 출처 표기]**: 시사점(implication)에서 당신이 새롭게 제시한 **외부 유사 사례나 레퍼런스**에 대한 출처를 표기하십시오. **주의: 현재 요약하고 있는 원본 기사의 출처를 동어반복하여 적지 마십시오.** 외부 사례를 언급한 경우, 내용이 모두 끝난 후 **새로운 줄(빈 줄)을 하나 추가하고** `[참고 출처: 사례와 관련된 실제 언론사명 "관련 기사 제목 또는 보고서명"]` 형태로 명확한 출처명과 제목을 표기해 주십시오.
