...
오늘의 주요 뉴스들을 분석하여 재단 업무(소상공인 지원, 보증, 컨설팅 등)에 실질적 도움이 될 인사이트 리포트를 작성해 주세요.
...
2. **구조**:
   - [오늘의 주요 경제 흐름]: 전체 뉴스에서 도출되는 핵심적인 거시 경제 상황을 한 문단으로 정리.
   - [재단 업무 연계 인사이트]: 가장 중요한 뉴스 3~5개를 선정하여 아래 형식으로 기술.
     * 뉴스 제목
     * 주요내용 요약: 해당 뉴스의 핵심 사실 관계 요약.
     * 업무 시사점: 재단 업무(보증 심사, 소상공인 컨설팅, 정책 제언 등)와의 구체적 연계성 및 대응 방안.
