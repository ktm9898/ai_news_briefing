...
1. [주간 거시 경제 흐름 (economic_trend)]:
   ...
   - 단편적인 요약에 그치지 말고, 2~3개의 논리적 문단(문단 구분: \\n\\n)으로 800~1,000자 내외로 충실하고 넉넉한 분량으로 작성하십시오.
...
2. [소기업·소상공인 3대 핵심 사안 선정 및 심층 분석 (news_insights)]:
   ...
   - **implication (인사이트 및 실전 대응 전략)**:
     - 일반론적 조언(예: '비용을 줄이세요')을 철저히 배제하고, 소상공인이 현장에서 즉시 실천할 수 있는 구체적 운영 전술과 중장기 전략을 제시하십시오.
     - **[필수 포함 내용]**:
       ① 단기적 현장 대응책 (원가·가격 정책, 매장 운영 효율화, 로컬 마케팅 등)
       ② 중장기 경쟁력 강화 방안 (디지털/플랫폼 활용, 정부·서울시 지원제도 및 보증상품 연계 등)
       ③ 위기 극복 또는 혁신에 성공한 국내외 벤치마킹 유사 사례 (구체적 팩트 기반)
