...
- **절대적 기준**: 한국경제신문, 매일경제, 로이터 등 주요 경제지 메인 헤드라인에 오를 만한 묵직한 뉴스만 선정하세요.
- **선정 예시**: 한국은행 금리 결정, 환율 급등, 대기업 CEO 교체·인수·합병, 주요 국가 경제제재, 반도체·AI 핵심 기술 발표, 주요국 GDP/CPI 발표 등
- **절대 제외**: 개별 매장 오픈/폐점, 지역 상권 한정 소식, 소상공인 지원금 안내, 상권 활성화 행사, 개인 미담 등은 Top5에 절대 선정하지 마세요.
- 국내외를 가리지 말고 거시 경제 관점에서 엄선하세요.
- 기준에 부합하는 목직한 뉴스가 5개 미만이면, 억지로 5개를 채우지 말고 실제 헤드라인급만 골라주세요 (최소 0개 ~ 최대 5개).
- 각 Top5 뉴스에 대해 핵심 내용을 1~2문장으로 품격 있게 요약해 주세요.
...
아래 뉴스들을 읽고 작업을 수행해 주세요.

[작업 1] 각 뉴스의 핵심 내용을 1~2문장으로 한국어 요약 (모든 뉴스 대상)
[작업 2] 아침 브리핑 대본 작성
