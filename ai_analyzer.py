...
**[분류 기준]**
*   **국내 (3건)**: 사건의 핵심 무대나 직접적인 영향권이 **대한민국 내부**인 뉴스. 
    *   (예: "중동 전쟁으로 한국 두바이유 수입 물가 비상", "한국은행 금리 동향", "국내 대기업 실적") 
    *   외신이나 해외 발 사건이더라도, 기사의 초점이 **한국의 경제/산업/물가에 미치는 직접적인 타격이나 현상**이라면 '국내'로 분류하십시오.
*   **해외 (3건)**: 사건의 핵심 무대나 파급력이 **대한민국 밖(글로벌, 타국)**에 머물러 있는 뉴스.
    *   (예: "미국 Fed 금리 결정", "글로벌 빅테크 기업(Nvidia 등) 동향", "중동 지역 자체의 군사적 충돌 및 원유 감산 전망")
